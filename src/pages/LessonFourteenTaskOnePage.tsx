...
const TASKS: Task[] = [
  { type: 'choice', prompt: 'Я ______ пить воду.', options: ['хочешь', 'хочет', 'хочу', 'хотим'], correct: 'хочу' },
  { type: 'choice', prompt: 'Мы ______ учить русский язык.', options: ['хотите', 'хотим', 'хотят', 'хочешь'], correct: 'хотим' },
  { type: 'choice', prompt: 'Она ______ купить книгу.', options: ['хочу', 'хотят', 'хочет', 'хотим'], correct: 'хочет' },
  { type: 'choice', prompt: 'Ты ______ смотреть этот фильм?', options: ['хочешь', 'хочу', 'хочет', 'хотите'], correct: 'хочешь' },
  { type: 'choice', prompt: 'Они ______ поехать в Москву.', options: ['хотим', 'хочет', 'хотите', 'хотят'], correct: 'хотят' },
  {
    type: 'matching',
    prompt: 'Juftini toping (хотеть)',
    pairs: [
      { left: 'Я ______ работать.', right: 'хочу' },
      { left: 'Ты ______ отдыхать.', right: 'хочешь' },
      { left: 'Он ______ есть.', right: 'хочет' },
      { left: 'Мы ______ учиться.', right: 'хотим' },
      { left: 'Они ______ играть.', right: 'хотят' },
    ],
  },
  {
    type: 'sentence',
    prompt: 'Men suv ichishni xohlayman.',
    words: ['я', 'пить', 'хочу', 'мы', 'воду', 'хочешь'],
    correct: 'я хочу пить воду',
  },
  {
    type: 'sentence',
    prompt: 'U kitob o‘qishni xohlaydi.',
    words: ['она', 'читать', 'книгу', 'хотим', 'хочет', 'они'],
    correct: 'она хочет читать книгу',
  },
  {
    type: 'sentence',
    prompt: 'Biz rus tilini o‘rganishni xohlaymiz.',
    words: ['мы', 'учить', 'хотят', 'русский', 'язык', 'хотим', 'ты'],
    correct: 'мы хотим учить русский язык',
  },
  {
    type: 'sentence',
    prompt: 'Sen kino ko‘rishni xohlaysan.',
    words: ['ты', 'хочу', 'смотреть', 'фильм', 'хочешь', 'она'],
    correct: 'ты хочешь смотреть фильм',
  },
  {
    type: 'sentence',
    prompt: 'Ular Moskvaga borishni xohlashadi.',
    words: ['они', 'поехать', 'в Москву', 'хотят', 'хочет', 'мы'],
    correct: 'они хотят поехать в Москву',
  },
];
...
export default function LessonFourteenTaskOnePage() {
        ...
        {finished && (
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white px-4 py-6 shadow-sm">
            ...
            <button
              type="button"
              onClick={() => {
                if (TASKS.length > 0) setLessonTaskResult('/lesson-14', 1, correctCount, TASKS.length);
                if (token) {
                  saveLessonTaskResult(token, '/lesson-14', 1, correctCount, TASKS.length);
