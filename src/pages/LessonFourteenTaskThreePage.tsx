...
const TASKS: Task[] = [
  { type: 'choice', prompt: 'Я ______ телефон.', options: ['берёшь', 'беру', 'берёт', 'берём'], correct: 'беру' },
  { type: 'choice', prompt: 'Она ______ книгу.', options: ['беру', 'берут', 'берёт', 'берёшь'], correct: 'берёт' },
  { type: 'choice', prompt: 'Мы ______ билеты.', options: ['берём', 'берёт', 'беру', 'берёте'], correct: 'берём' },
  { type: 'choice', prompt: 'Ты ______ мой карандаш?', options: ['беру', 'берёшь', 'берёт', 'берут'], correct: 'берёшь' },
  { type: 'choice', prompt: 'Они ______ такси.', options: ['берёт', 'берём', 'берут', 'беру'], correct: 'берут' },
  {
    type: 'matching',
    prompt: 'Juftini toping (брать)',
    pairs: [
      { left: 'Я ______ деньги.', right: 'беру' },
      { left: 'Ты ______ ручку.', right: 'берёшь' },
      { left: 'Он ______ сумку.', right: 'берёт' },
      { left: 'Мы ______ документы.', right: 'берём' },
      { left: 'Они ______ зонт.', right: 'берут' },
    ],
  },
  {
    type: 'sentence',
    prompt: 'Men pulni olaman.',
    words: ['я', 'беру', 'деньги', 'мы', 'берёшь', 'сегодня'],
    correct: 'я беру деньги',
  },
  {
    type: 'sentence',
    prompt: 'U kitobni oladi.',
    words: ['она', 'берёт', 'книгу', 'беру', 'они', 'вчера'],
    correct: 'она берёт книгу',
  },
  {
    type: 'sentence',
    prompt: 'Biz hujjatlarni olamiz.',
    words: ['мы', 'берём', 'документы', 'берут', 'ты', 'сейчас'],
    correct: 'мы берём документы',
  },
  {
    type: 'sentence',
    prompt: 'Sen mening ruchkamni olasanmi?',
    words: ['ты', 'берёшь', 'мою', 'ручку', 'беру', 'я'],
    correct: 'ты берёшь мою ручку',
  },
  {
    type: 'sentence',
    prompt: 'Ular taksi olishyapti (olishadi).',
    words: ['они', 'берут', 'такси', 'берёт', 'мы', 'часто'],
    correct: 'они берут такси',
  },
];
