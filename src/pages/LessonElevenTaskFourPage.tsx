...
const TASKS: SentenceTask[] = [
  {
    prompt: 'Savol tuzing: Kim rus tilini o‘rganadi?',
    words: ['кто', 'учит', 'учат', 'русский', 'язык', 'он'],
    correct: 'кто учит русский язык',
  },
  {
    prompt: 'Savol tuzing: Kim universitetda tushlik qiladi?',
    words: ['кто', 'обедает', 'обедают', 'в', 'университете', 'они'],
    correct: 'кто обедает в университете',
  },
  {
    prompt: 'Savol tuzing: Kim ruscha gapiradi?',
    words: ['кто', 'говорит', 'говорят', 'по-русски', 'он'],
    correct: 'кто говорит по-русски',
  },
  {
    prompt: 'Savol tuzing: Kim parkda sayr qiladi?',
    words: ['кто', 'гуляет', 'гуляют', 'в', 'парке', 'они'],
    correct: 'кто гуляет в парке',
  },
  {
    prompt: 'Savol tuzing: Kim jurnallarni o‘qiydi?',
    words: ['кто', 'читает', 'читают', 'журналы', 'он'],
    correct: 'кто читает журналы',
  },
  {
    prompt: 'Savol tuzing: Kim telefon orqali gaplashadi?',
    words: ['кто', 'разговаривает', 'разговаривают', 'по', 'телефону', 'они'],
    correct: 'кто разговаривает по телефону',
  },
  {
    prompt: 'Savol tuzing: Kim auditoriyada shug‘ullanadi?',
    words: ['кто', 'занимается', 'занимаются', 'в', 'аудитории', 'они'],
    correct: 'кто занимается в аудитории',
  },
  {
    prompt: 'Savol tuzing: Kim darsni tushuntiradi?',
    words: ['кто', 'объясняет', 'объясняют', 'урок', 'они'],
    correct: 'кто объясняет урок',
  },
  {
    prompt: 'Savol tuzing: Kim chizadi?',
    words: ['кто', 'рисует', 'рисуют', 'они'],
    correct: 'кто рисует',
  },
];
...
export default function LessonElevenTaskFourPage() {
  ...
  const handleNext = () => {
    if (currentIndex < TASKS.length - 1) setCurrentIndex((prev) => prev + 1);
      ...
      if (TASKS.length > 0) setLessonTaskResult('/lesson-11', 5, TASKS.length, TASKS.length);
      setFinished(true);
    }
  };
