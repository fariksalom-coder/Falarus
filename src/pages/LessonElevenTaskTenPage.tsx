...
const TASKS: SentenceTask[] = [
  {
    prompt: 'Gapni tuzing: Он говорит: «Я знаю слова».',
    words: ['он', 'говорит', 'что', 'я', 'он', 'знает', 'знаю', 'слова'],
    correct: 'он говорит что он знает слова',
  },
  {
    prompt: 'Gapni tuzing: Ты пишешь: «Брат много работает».',
    words: ['ты', 'пишешь', 'что', 'брат', 'много', 'работает', 'работаю', 'я'],
    correct: 'ты пишешь что брат много работает',
  },
  {
    prompt: 'Gapni tuzing: Студентка говорит: «Вечером студенты гуляют».',
    words: ['студентка', 'говорит', 'что', 'вечером', 'студенты', 'гуляют', 'гуляет', 'она'],
    correct: 'студентка говорит что вечером студенты гуляют',
  },
  {
    prompt: 'Gapni tuzing: Друг говорит: «После занятий я обедаю».',
    words: ['друг', 'говорит', 'что', 'после', 'занятий', 'я', 'он', 'обедает', 'обедаю'],
    correct: 'друг говорит что после занятий он обедает',
  },
  {
    prompt: 'Gapni tuzing: Они пишут: «Мы учим русский язык».',
    words: ['они', 'пишут', 'что', 'мы', 'они', 'учат', 'учим', 'русский', 'язык'],
    correct: 'они пишут что они учат русский язык',
    accepted: ['они пишут что мы учим русский язык', 'они пишут что они учат язык русский', 'они пишут что мы учим язык русский'],
  },
  {
    prompt: 'Gapni tuzing: Ты говоришь: «Я смотрю телевизор каждый день».',
    words: ['ты', 'говоришь', 'что', 'я', 'ты', 'смотришь', 'смотрю', 'телевизор', 'каждый', 'день'],
    correct: 'ты говоришь что ты смотришь телевизор каждый день',
  },
];
...
export default function LessonElevenTaskTenPage() {
  ...
  const handleNext = () => {
    if (currentIndex < TASKS.length - 1) setCurrentIndex((prev) => prev + 1);
      ...
      if (TASKS.length > 0) setLessonTaskResult('/lesson-11', 11, TASKS.length, TASKS.length);
      setFinished(true);
    }
  };
