...
const TASKS: SentenceTask[] = [
  {
    prompt: 'Когда – кто – путешествовать',
    words: ['летом', 'они', 'путешествуют', 'путешествует', 'я'],
    correct: 'летом они путешествуют',
  },
  {
    prompt: 'Когда – кто – заниматься',
    words: ['вечером', 'он', 'занимается', 'занимаюсь', 'они'],
    correct: 'вечером он занимается',
  },
  {
    prompt: 'Когда – кто – вставать',
    words: ['утром', 'ты', 'встаёшь', 'встают', 'он'],
    correct: 'утром ты встаёшь',
  },
  {
    prompt: 'Когда – кто – гулять',
    words: ['вечером', 'она', 'гуляет', 'гуляют', 'мы'],
    correct: 'вечером она гуляет',
  },
  {
    prompt: 'Кто – как – читать',
    words: ['он', 'быстро', 'читает', 'читают', 'я'],
    correct: 'он быстро читает',
  },
  {
    prompt: 'Кто – как – слушать',
    words: ['она', 'внимательно', 'слушает', 'слушают', 'мы'],
    correct: 'она внимательно слушает',
  },
  {
    prompt: 'Кто – как – понимать',
    words: ['он', 'хорошо', 'понимает', 'понимают', 'я'],
    correct: 'он хорошо понимает',
  },
  {
    prompt: 'Кто – как – спрашивать',
    words: ['она', 'медленно', 'спрашивает', 'спрашивают', 'мы'],
    correct: 'она медленно спрашивает',
  },
];
...
export default function LessonElevenTaskFivePage() {
  ...
  const handleNext = () => {
    if (currentIndex < TASKS.length - 1) setCurrentIndex((prev) => prev + 1);
      ...
      if (TASKS.length > 0) setLessonTaskResult('/lesson-11', 6, TASKS.length, TASKS.length);
      setFinished(true);
    }
  };
        ...
        {!finished && (
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
            <div className="space-y-1 text-center">
              <p className="text-sm font-semibold text-slate-600">Model bo‘yicha gap tuzing</p>
              <p className="text-2xl font-bold text-slate-900">{currentTask.prompt}</p>
            </div>
