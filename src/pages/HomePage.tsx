    ...
    <div className="min-h-screen pb-12" style={{ backgroundColor: BG }}>
      <main className="mx-auto max-w-4xl px-4 py-5 sm:px-5">
        ...
        <div className="space-y-4">
          {COURSES.map(({ id, href, title, subtitle, accent, imageSrc, emoji }) => (
            <button
              key={id}
              type="button"
            ...
            >
              <div className="flex items-center gap-4">
                {imageSrc ? (
                  ...
                  <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-blue-100 text-[2rem] shadow-[0_12px_24px_rgba(37,99,235,0.18)] sm:h-[72px] sm:w-[72px]">
                    {emoji}
                  </div>
                )}
