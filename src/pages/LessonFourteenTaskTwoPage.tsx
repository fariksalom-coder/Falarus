...
const TASKS: Task[] = [
  { type: 'choice', prompt: 'Я ______ говорить по-русски.', options: ['можешь', 'могу', 'может', 'можем'], correct: 'могу' },
  { type: 'choice', prompt: 'Она ______ прийти сегодня.', options: ['могут', 'могу', 'может', 'можешь'], correct: 'может' },
  { type: 'choice', prompt: 'Мы ______ помочь вам.', options: ['можем', 'может', 'могу', 'можешь'], correct: 'можем' },
  { type: 'choice', prompt: 'Ты ______ открыть дверь?', options: ['могу', 'можем', 'можешь', 'могут'], correct: 'можешь' },
  { type: 'choice', prompt: 'Они ______ быстро бегать.', options: ['может', 'можем', 'можешь', 'могут'], correct: 'могут' },
  {
    type: 'matching',
    prompt: 'Juftini toping (мочь)',
    pairs: [
      { left: 'Я ______ читать.', right: 'могу' },
      { left: 'Ты ______ помочь.', right: 'можешь' },
      { left: 'Он ______ работать.', right: 'может' },
      { left: 'Мы ______ прийти.', right: 'можем' },
      { left: 'Они ______ ждать.', right: 'могут' },
    ],
  },
  {
    type: 'sentence',
    prompt: 'Men yordam bera olaman.',
    words: ['я', 'могу', 'помочь', 'мы', 'можешь', 'ему'],
    correct: 'я могу помочь ему',
  },
  {
    type: 'sentence',
    prompt: 'U bugun kela oladi.',
    words: ['он', 'может', 'прийти', 'могу', 'сегодня', 'ты'],
    correct: 'он может прийти сегодня',
  },
  {
    type: 'sentence',
    prompt: 'Biz bu yerda kutib tura olamiz.',
    words: ['мы', 'можем', 'ждать', 'здесь', 'можешь', 'она'],
    correct: 'мы можем ждать здесь',
  },
  {
    type: 'sentence',
    prompt: 'Sen mashina hayday olasanmi?',
    words: ['ты', 'можешь', 'водить', 'машину', 'могу', 'я'],
    correct: 'ты можешь водить машину',
    // question mark ignored in assembled token flow
  },
  {
    type: 'sentence',
    prompt: 'Ular tez ishlay olishadi.',
    words: ['они', 'могут', 'быстро', 'работать', 'может', 'мы'],
    correct: 'они могут быстро работать',
  },
];
...
export default function LessonFourteenTaskTwoPage() {
