...
export const LESSON_9_VAZIFALARI: {
  ...
  { vazifaId: 2, label: 'Vazifa 2', hint: 'Juftini toping', tasks: LESSON_9_VAZIFA_MATCHING },
  { vazifaId: 3, label: 'Vazifa 3', hint: 'Gapni tuzing', tasks: LESSON_9_VAZIFA_SENTENCE },
];
