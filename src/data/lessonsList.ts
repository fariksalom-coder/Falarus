...
export const LESSONS = [
  ...
  { id: 4, num: 4, title: 'Род существительных', titleUz: 'Otlarning jinsi', titleRu: 'Род существительных', icon: '🔤', path: '/lesson-4', exercisesTotal: 3 },
  { id: 5, num: 5, title: 'Слова на -ь', titleUz: 'Yumshoq belgili so‘zlar', titleRu: 'Слова на -ь', icon: '✏️', path: '/lesson-5', exercisesTotal: 3 },
  ...
  { id: 10, num: 10, title: 'Инфинитив', titleUz: 'Infinitiv', titleRu: 'Инфинитив', icon: '♾️', path: '/lesson-10', exercisesTotal: 3 },
