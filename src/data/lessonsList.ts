...
export const LESSONS = [
  { id: 1, num: 1, title: 'Знакомство', titleUz: 'Tanishuv', titleRu: 'Знакомство', icon: '👋', path: '/lesson-1', exercisesTotal: 3 },
  { id: 2, num: 2, title: 'Личные местоимения', titleUz: 'Kishilik olmoshlari', titleRu: 'Личные местоимения', icon: '👤', path: '/lesson-2', exercisesTotal: 3 },
  { id: 3, num: 3, title: 'Части речи', titleUz: 'So‘z turkumlari', titleRu: 'Части речи', icon: '📚', path: '/lesson-3', exercisesTotal: 3 },
  { id: 4, num: 4, title: 'Род существительных', titleUz: 'Otlarning jinsi', titleRu: 'Род существительных', icon: '🔤', path: '/lesson-4', exercisesTotal: 2 },
  { id: 5, num: 5, title: 'Слова на -ь', titleUz: 'Yumshoq belgili so‘zlar', titleRu: 'Слова на -ь', icon: '✏️', path: '/lesson-5', exercisesTotal: 2 },
  { id: 6, num: 6, title: 'Чей? Чья? Чьё?', titleUz: 'Kimniki?', titleRu: 'Чей? Чья? Чьё?', icon: '❓', path: '/lesson-6', exercisesTotal: 3 },
  { id: 7, num: 7, title: 'Имя прилагательное', titleUz: 'Sifat', titleRu: 'Имя прилагательное', icon: '📝', path: '/lesson-7', exercisesTotal: 3 },
  { id: 8, num: 8, title: 'Множественное число', titleUz: 'Ko‘plik', titleRu: 'Множественное число', icon: '🔢', path: '/lesson-8', exercisesTotal: 3 },
  { id: 9, num: 9, title: 'Повторение', titleUz: 'Takrorlash', titleRu: 'Повторение', icon: '🔄', path: '/lesson-9', exercisesTotal: 3 },
  { id: 10, num: 10, title: 'Инфинитив', titleUz: 'Infinitiv', titleRu: 'Инфинитив', icon: '♾️', path: '/lesson-10', exercisesTotal: 2 },
