    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1.5 flex flex-wrap gap-2">
            <span className="rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-semibold text-[#071B5E] dark:bg-blue-500/15 dark:text-blue-300">
      ...
      {canSendRequest && (
        <button
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#123A8F] to-[#0B2A6B] px-5 py-3 text-sm font-bold text-white shadow-[0_6px_20px_rgba(11,42,107,0.25)] transition-all hover:shadow-[0_10px_28px_rgba(11,42,107,0.35)] disabled:opacity-50"
        >
