  ...
  return (
    <label className="flex cursor-pointer items-start gap-2.5">
      <input
        ...
        className="mt-0.5 h-4 w-4 shrink-0 rounded border-app-border-strong bg-app-surface text-app-brand focus:ring-[#2F6BFF]"
      />
      <span className="text-[13px] leading-snug text-app-text-muted">
        {t('auth.termsPrefix')}
