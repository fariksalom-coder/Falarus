  ...
  return (
    <div
      className={`
        ...
        ${isCurrentUser ? 'ring-2 ring-[#0B2A6B] shadow-[0_18px_40px_rgba(11,42,107,0.16)]' : ''}
      `}
    ...
    >
      ...
      <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#EAF4FF] text-xl font-bold text-[#0B2A6B] sm:h-16 sm:w-16 sm:text-2xl">
        {user.avatarUrl ? (
